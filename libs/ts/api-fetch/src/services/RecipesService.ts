...
import type { dtos_FetchRecipeResponse } from '../models/dtos_FetchRecipeResponse';
...
export class RecipesService {
     ...
     * Request Recipe Fetch
     * @param recipe Recipe Data
     * @returns dtos_FetchRecipeResponse OK
     * @throws ApiError
     */
    public postApiRecipesFetch(
        recipe: dtos_FetchRecipeRequest,
    ): CancelablePromise<dtos_FetchRecipeResponse> {
        return this.httpRequest.request({
            method: 'POST',
